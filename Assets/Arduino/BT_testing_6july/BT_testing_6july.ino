...
void setup() {
  ...
  Serial.println("COMM: Arduino started...");
  btSerial.println("BT: Arduino started...");
...
void loop() {  
  ...
  if (btSerial.available()){
    ...
    switch(command){
      case 's':
        Serial.println("received command: s. Did nothing");
        //start = true; 
      break;
      case 'l':
        Serial.println("received command: l");
        my_code();
        Serial.println("LED toggled");
      break;
      case 'f':
        Serial.println("received command: f. Did nothing.");
        //start = false;
        //Serial.end();
      break;
    }
